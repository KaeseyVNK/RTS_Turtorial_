...
public class PlacementState : IBuildingState
{
    ...
    public void OnAction(Vector3Int gridPosition)
    {
        ...
        //Get buildingType of the building that we just built
    ...
    private bool CheckPlacementValidity(Vector3Int gridPosition, int selectedObjectIndex)
    {
        ...
        //check if the grid cell is already oocupied by another object from the GridData 
        ...
        {
            if (collider.CompareTag("Unit") || collider.CompareTag("Tree") || collider.CompareTag("Enemy")) //add more tags
            {
                return false;
            }
        }
